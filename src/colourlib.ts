...
class XYZ extends ThreeDimColourFormat {
    ...
    blend(other: XYZ, prop: number = 0.5) {
        const neg = 1 - prop
...
const D65 = new XYZ(95.047 / 100, 1, 108.883 / 100)
const D50 = new XYZ(0.9642, 1, 0.8249)

function getSpectral(nm: number): XYZ {
